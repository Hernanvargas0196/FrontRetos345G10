...
function pintarRespuestaPartyroom(response){
    ...
    "<thead><tr><th>NOMBRE SALON</th><th>PROPIETARIO</th><th>CAPACIDAD</th><th>DESCRIPCION</th><th>NOMBRE CATEGORIA</th><th colspan='3'></th></tr></thead>";
    ...
    myTable+="<tr>";
        ...
        myTable+='<td><button class = "ui yellow button" onclick="cargarDatosPartyroom(' + response[i].id + ')">Editar!</button></td>';
